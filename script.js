  ...
  if (contactForm) {
    contactForm.addEventListener('submit', async function(e) {
      ...
      try {
        ...
        const response = await fetch('https://formspree.io/f/myzjrana', {
          method: 'POST',
          headers: {
...
${data.message}
        ...
        const mailtoLink = `mailto:abakharshal@gmail.com?subject=${emailSubject}&body=${emailBody}`;
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  const criticalImages = [
    './assets/HarshalAbak_Portfolio.jpg',
    './assets/cursor.png'
  ];
